  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-users-gear"></i> Create official</h5>
      ...
      <div class="modal-body">
        <form action="process_save.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control"  placeholder="Last name" name="degree" required>
          </div>
          <div class="form-group">
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn bg-gradient-primary" name="create_official"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
      </div>
      </form>
    </div>
  </div>
