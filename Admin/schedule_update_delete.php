<!-- UPDATE -->
<div class="modal fade" id="update<?php echo $row['SchedID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
          ...
          <div class="row">
            <div class="col-lg-8 mb-3">
                ...
                <select class="form-control" name="instructor" required >
                  ...
                  ?>
                  <option value="<?php echo $ins['InstructorID']; ?>" <?php if($row['InstructorID'] == $ins['InstructorID']) { echo 'selected'; } ?>><?php echo ' '.$ins['Firstname'].' '.$ins['Middlename'].' '.$ins['Lastname'].' '; ?></option>
                  <?php } } else { ?>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <select class="form-control" name="course" required >
                  ...
                  ?>
                  <option value="<?php echo $c['CourseID']; ?>" <?php if($row['CourseID'] == $c['CourseID']) { echo 'selected'; } ?>><?php echo $c['CourseCode']; ?></option>
                  <?php } } else { ?>
            ...
            <div class="col-lg-6 mb-3">
                ...
                <select class="form-control" name="day" required >
                  ...
                  ?>
                  <option value="<?php //echo $d['DayID']; ?>" <?php //if($row['DayID'] == $d['DayID']) { echo 'selected'; } ?>><?php //echo ''.$d['DayName'].' - '.$d['DayCode'].''; ?></option>
                  <?php// } } else { ?>
                  <option value="" selected>There are no Day records saved in the database.</option>
                  <?php //} ?>
                </select> -->
                <span><b>Day</b></span>
                <input type="text" class="form-control" placeholder="Monday, Tuesday, Wednesday, Thursday, Friday" name="day" required value="<?php echo $row['DayID']; ?>">
            </div>

            <div class="col-lg-3 mb-3">
                <span><b>Time start</b></span>
                <input type="text" class="form-control" placeholder="01:00 AM - 02:00 AM" name="timestart" required value="<?php echo $row['TimeStart']; ?>">
            </div>

            <div class="col-lg-3 mb-3">
                <span><b>Time end</b></span>
                <input type="text" class="form-control" placeholder="01:00 PM - 02:00 PM" name="timeend" required value="<?php echo $row['TimeEnd']; ?>">
            </div>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <select class="form-control" name="room" required >
                  ...
                  ?>
                  <option value="<?php echo $r['RoomID']; ?>" <?php if($row['RoomID'] == $r['RoomID']) { echo 'selected'; } ?>><?php echo ''.$r['RoomName'].' - '.$r['RoomCode'].''; ?></option>
                  <?php } } else { ?>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <select class="form-control" name="semester" required >
                  ...
                  ?>
                  <option value="<?php echo $s['SemesterID']; ?>" <?php if($row['SemesterID'] == $s['SemesterID']) { echo 'selected'; } ?>><?php echo ''.$s['SemesterName'].' - '.$s['SemesterCode'].''; ?></option>
                  <?php } } else { ?>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <select class="form-control" name="schoolyear" required >
                  ...
                  ?>
                  <option value="<?php echo $sy['SyID']; ?>" <?php if($row['SyID'] == $sy['SyID']) { echo 'selected'; } ?>><?php echo ''.$sy['SyName'].' - '.$sy['SyCode'].''; ?></option>
                  <?php } } else { ?>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn bg-gradient-primary" name="update_schedule"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
      </div>
      </form>
    </div>
  </div>
...
<!-- DELETE -->
<div class="modal fade" id="delete<?php echo $row['SchedID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer alert-light">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa-solid fa-ban"></i> Cancel</button>
        <button type="submit" class="btn bg-gradient-primary" name="delete_schedule"><i class="fa-solid fa-trash-can"></i> Delete</button>
      </div>
        </form>
    </div>
  </div>
